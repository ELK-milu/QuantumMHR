...
namespace Quantum.Prototypes.Unity {
  ...
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.WireBug))]
  public class WireBug_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.WireBug_Prototype> {
    ...
    public Quantum.Prototypes.WireBugStatus_Prototype[] WireBugStatus = System.Array.Empty<Quantum.Prototypes.WireBugStatus_Prototype>();
    public Quantum.QBoolean Interactable;

    public sealed override Quantum.Prototypes.WireBug_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.WireBug_Prototype();
      result.PlayerRef = this.PlayerRef;
      converter.Convert(this.Entity, out result.Entity);
      result.WireBugStatus = this.WireBugStatus;
      result.Interactable = this.Interactable;
      return result;
    }
  }
  [System.SerializableAttribute()]
